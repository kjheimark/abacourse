...
public class BackendServer {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final Application application = createApplication(smsClient, databaseManager);
    ...
    private static DatabaseManager createDatabaseManager() throws Exception {
        final String mysqlUrl = "jdbc:mysql://mysql:3306/";
        final String mysqlUsername = "admin";
        final String mysqlPassword = "test";
        Class.forName("com.mysql.jdbc.Driver").newInstance();
        return new DatabaseManager(mysqlUrl, mysqlUsername, mysqlPassword);
    }
